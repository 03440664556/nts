			...
			<div class="sticky-menu">
				<div class="grid-row clear-fix">
					...
					<a href="index.php" class="logo">
						<img src="img/ntsmain.jpg"  data-at2x="img/logo@2x.png" alt>
<!-- 						<h1>NTS</h1>
 -->					</a>
					<!-- / logo -->
					<nav class="main-nav">
						<ul class="clear-fix">
							<li>
								...
								<!-- sub menu -->
								<!-- <ul>
									<li><a href="index.php" class="active">Full-Width Slider</a></li>
							...
							<li class="megamenu">
								<a href="content-elements.html">About Us</a>
								<ul class="clear-fix">
								<li><div class="header-megamenu">About Us</div>
									...
									<li><div class="header-megamenu">Division</div>
										<ul>
											<li><a href="page-about-us.html">About Us</a></li>
											<li><a href="page-our-staff.html">Our Staff</a></li>
											<li><a href="page-services.php">Services</a></li>
							...
							<li>
								<a href="courses-grid.html">Tests & Products</a>
								<!-- sub menu -->
								<ul>
									<li><a href="courses-grid.html">Courses grid</a></li>
									<li><a href="newprojects.php">Courses list</a></li>
									<li><a href="courses-single-item.html">Courses single item</a></li>
								</ul>
								<!-- / sub menu -->
							</li>
							<!-- <li>
								<a href="courses-grid.html">Services</a>
								<ul>
									<li><a href="courses-grid.html">Courses grid</a></li>
									<li><a href="newprojects.php">Courses list</a></li>
									<li><a href="courses-single-item.html">Courses single item</a></li>
							...
							<li>
								<a href="courses-grid.html">CSR</a>
								<!-- sub menu -->
								<ul>
									<li><a href="courses-grid.html">Courses grid</a></li>
									<li><a href="newprojects.php">Courses list</a></li>
							...
							<!-- <li>
								<a href="newprojects.php">Shop</a>
								<ul>
									<li><a href="newprojects.php">Product List</a></li>
									<li><a href="candidates.php">Single Product</a></li>
									<li><a href="shop-checkout.html">Checkout</a></li>
									<li><a href="shop-cart.html">Shop Cart</a></li>
								</ul>
							</li> -->
							<li>
							<a href="services.php">Adi</a>
                            </li>
                            <li>
                                <a href="#">Contact Us</a>
                                <!-- sub menu -->
